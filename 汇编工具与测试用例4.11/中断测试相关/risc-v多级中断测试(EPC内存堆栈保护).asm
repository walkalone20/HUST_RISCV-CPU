...
csrrsi s6,0x41,0   #s6=mepc  
sw s6, 0(sp)       #mepc压栈保护
addi sp, sp, 4


################# 开中断
csrrsi zero,0x4,1   #mie=1
...
################# 关中断
csrrci zero,0x4,1   #mie=0

################# 恢复现场
addi sp, sp, -4
lw s6, 0(sp)
csrrw zero,0x41,s6  #mepc=s6
